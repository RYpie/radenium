...
def parseEnvelope(data):
    '''
    I have never seen such a crap shit as parsing SOAP messages with python xml parsers...
    So pick beautifulsoup that parses every shit soup.
    '''
    try:
        dom = BeautifulSoup( data )
        soapAction = dom.findAll('wsa:action')[0].text
...
if __name__ == "__main__":
    ...
    ret = wsd.searchServices(timeout=10)

...
class RadeniumControllerLive extends JControllerForm
{
    ...
    public function save()
    {
        if ($this->checkToken()) {
            ...
            $model = $this->getModel("live");
            $data = JFactory::getApplication()->input->get('jform','', 'array');
            $model->save($data);
            
            $this->setRedirect( JRoute::_('index.php?option='.$option.'&view=live&layout=default', false));
        }
    ...
    public function modify()
    {
        if ($this->checkToken()) {
            ...
            $model = $this->getModel("live");
            $data = JFactory::getApplication()->input->get('jform','', 'array');
            $model->edit( JFactory::getApplication()->input->get("live_id"),$data );
    ...
    public function edit()
    {
        if ($this->checkToken()) {
            ...
            $this->setRedirect( JRoute::_('index.php?option='.$option.'&view=live&layout=edit&live_id='.$id, false));
        }

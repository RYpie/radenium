...
<h1><?php echo JText::_('COM_radenium_VIEW_EDIT_ENTRY'); ?></h1>
    <form class="form-validate" enctype="multipart/form-data" action="<?php echo JRoute::_('index.php'); ?>" method="post" id="radenium_systemdevices" name="radenium_systemdevices">
    ...
    <input type="hidden" name="systemdevices_id" value="<?php echo $this->systemdevices_id; ?>" />
    <br />

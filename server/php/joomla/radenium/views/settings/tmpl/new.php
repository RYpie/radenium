...
<h1><?php echo JText::_('COM_radenium_VIEW_NEW_ENTRY'); ?></h1>
    <form class="form-validate" enctype="multipart/form-data" action="<?php echo "index.php?option=com_radenium&view=settings&layout=default"; /*JRoute::_('index.php'); */?>" method="post" id="radenium_settings" name="radenium_settings">

...
<h1><?php echo JText::_('COM_radenium_VIEW_NEW_ENTRY'); ?></h1>
    <form class="form-validate" enctype="multipart/form-data" action="<?php echo "index.php?option=com_radenium&view=encdck_encodetasks&layout=default"; /*JRoute::_('index.php'); */?>" method="post" id="radenium_encdck_encodetasks" name="radenium_encdck_encodetasks">

...
(1, 'Apple HLS', '-y -r 30 -f avfoundation -i {$DEVICES} -pix_fmt yuv420p -s {$OUT_RES} -hls_flags round_durations -hls_time 3 -hls_init_time 3 -threads 25 -async 1 {$OUT_DIR}{$OUT_NAME_M3U8}', 'all', 'takes'),

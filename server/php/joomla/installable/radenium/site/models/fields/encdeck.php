...
class JFormFieldEncdeck extends JFormFieldList {
	protected $type = 'Encdeck';
	...
	public function getOptions() {		
		...
		$query->select('id,name')->from('`#__radenium_encdeck`')->where('user_id = "'.$user->id.'"');

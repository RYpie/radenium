...
<div id="ffmpeg_new">
    <form class="form-validate" enctype="multipart/form-data" action="<?php echo JRoute::_('index.php'); ?>" method="post" id="radenium_ffmpeg" name="radenium_ffmpeg">
    <div class="form_rendered_container">
        <h3><?php echo JText::_('COMMANDS'); ?></h3>
        <div class="form_rendered_container_form">
            <?php $this->form->renderFieldSet("commands"); ?>
        </div>
    </div>
